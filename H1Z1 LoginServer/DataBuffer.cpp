...
namespace ObjectShema {
	...
	void DataBuffer::InitExtractorAndAppender()
	{
		...
		if (m_endianness == BigEndian)
		{
			m_extractor = std::bind(&ObjectShema::DataBuffer::ByteSwapExtractInteger, this, std::placeholders::_1, std::placeholders::_2);
			m_appender = std::bind(&ObjectShema::DataBuffer::ByteSwapAppendInteger, this, std::placeholders::_1, std::placeholders::_2);
		}
		else
		{
			m_extractor = std::bind(&ObjectShema::DataBuffer::NormalExtractInteger, this, std::placeholders::_1, std::placeholders::_2);
			m_appender = std::bind(&ObjectShema::DataBuffer::NormalAppendInteger, this, std::placeholders::_1, std::placeholders::_2);
		}
#endif
	}
	...
	{
		bool ret = 0;
		m_extractor((unsigned char*)& ret, sizeof(bool));
		return ret;
	}
	...
	void DataBuffer::WriteBool(const bool ul)
	{
		m_appender((const unsigned char*)& ul, sizeof(bool));
	}
